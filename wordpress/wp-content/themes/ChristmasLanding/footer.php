...
?>
  ...
  <div class="d-flex justify-content-center">
    <?php if (have_rows('ChristmasLanding_footer', 'option')) : ?>
        <?php while (have_rows('ChristmasLanding_footer', 'option')) : the_row(); ?>
            <?php 
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title" id="exampleModalLgLabel">ChristmasLanding</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <div class="text-center">
                <h1>Want to Join<br/>ChristmasLanding Event, 23<sup>rd</sup> December, 2024</h1>
